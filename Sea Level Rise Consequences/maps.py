...
def display_map(points: List[float], title: str, filepath: str) -> None:
    """
    Function to display a 3d world map that shows how much land is lost
    or how much population is displayed for each respective country.
...
if __name__ == '__main__':
    ...
    python_ta.check_all(config={
        'extra-imports': ['plotly.graph_objects', 'pandas', 'typing',
